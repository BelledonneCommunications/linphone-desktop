...
function main(){
    ...
    App.withInstance(shown, function(){
        ...
        test.verify(Settings.shows(FEATURE), "My account entry shown when hide_account_settings=0");
    });
    App.withInstance(hidden, function(){
        ...
        test.verify(Settings.hides(FEATURE), "My account entry hidden when hide_account_settings=1");
    });
}
