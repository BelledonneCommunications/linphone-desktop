...
function main(){
    ...
    App.withInstance(shown, function(){
        ...
        test.verify(Settings.shows(CTX, FEATURE), "Records entry shown when disable_call_recordings=0");
    });
    App.withInstance(hidden, function(){
        ...
        test.verify(Settings.hides(CTX, FEATURE), "Records entry hidden when disable_call_recordings=1");
    });
}
