...
function main(){
    ...
    App.withInstance(shown, function(){
        ...
        test.verify(Settings.shows(CTX, FEATURE), "Settings entry shown when hide_settings=0");
    });
    App.withInstance(hidden, function(){
        ...
        test.verify(Settings.hides(CTX, FEATURE), "Settings entry hidden when hide_settings=1");
    });
}
