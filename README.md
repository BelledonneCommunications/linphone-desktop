...
3. Build the whole project : `cmake --build . --target all --config RelWithDebInfo` or `cmake --build . --target ALL_BUILD --config RelWithDebInfo` in Windows. You can add `--parallel 10` if you have CMake>3.12 to speedup the process.
