...
//----
	...
	Q_PROPERTY(bool chatReactionsNotificationsEnabled READ getChatReactionsNotificationsEnabled WRITE setChatReactionsNotificationsEnabled NOTIFY chatReactionsNotificationsEnabledChanged)
