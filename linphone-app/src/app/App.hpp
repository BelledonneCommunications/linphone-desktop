...
public:
  ...
  void initContentApp ();
  QStringList cleanParserKeys(QStringList keys);// Get all options from parser and remove the selected keys. Return the result that can be passed to parser process.
