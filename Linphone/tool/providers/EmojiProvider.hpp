...
#ifndef EMOJI_PROVIDER_H_
#define EMOJI_PROVIDER_H_

#include <QQuickAsyncImageProvider>

// =============================================================================
class EmojiAsyncImageResponse : public QQuickImageResponse {
public:
	EmojiAsyncImageResponse(const QString &id, const QSize &requestedSize);
